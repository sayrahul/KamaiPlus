...
const Map<String, List<DefaultProductSeed>> kDefaultProductsByVertical = {
  ...
  'clothing': [
    ...
    // Generic template names — a clothing store's real stock is inherently
    // unique (own designs/suppliers), so this list gives quick-add starting
    // points rather than a barcode-matched catalog (see DEVELOPMENT_LOG.md).
    DefaultProductSeed(name: 'Men Polo T-Shirt (Size L)', categoryName: 'Men Shirts & T-Shirts', sellingPricePaise: 49900, mrpPaise: 69900, purchasePricePaise: 32000, stockQuantity: 10, unit: 'piece'),
    DefaultProductSeed(name: 'Men Checked Casual Shirt (Size 40)', categoryName: 'Men Shirts & T-Shirts', sellingPricePaise: 59900, mrpPaise: 84900, purchasePricePaise: 38000, stockQuantity: 8, unit: 'piece'),
    DefaultProductSeed(name: 'Women Cotton Nighty', categoryName: 'Women Kurtis & Sarees', sellingPricePaise: 34900, mrpPaise: 49900, purchasePricePaise: 22000, stockQuantity: 10, unit: 'piece'),
    DefaultProductSeed(name: 'Women Anarkali Suit Set', categoryName: 'Women Kurtis & Sarees', sellingPricePaise: 129900, mrpPaise: 189900, purchasePricePaise: 85000, stockQuantity: 6, unit: 'piece'),
    DefaultProductSeed(name: 'Women Palazzo Pants', categoryName: 'Jeans & Trousers', sellingPricePaise: 44900, mrpPaise: 64900, purchasePricePaise: 28000, stockQuantity: 10, unit: 'piece'),
    DefaultProductSeed(name: 'Men Formal Trousers (Size 34)', categoryName: 'Jeans & Trousers', sellingPricePaise: 79900, mrpPaise: 119900, purchasePricePaise: 52000, stockQuantity: 8, unit: 'piece'),
    DefaultProductSeed(name: 'Men Track Pants', categoryName: 'Sportswear & Activewear', sellingPricePaise: 39900, mrpPaise: 59900, purchasePricePaise: 25000, stockQuantity: 10, unit: 'piece'),
    DefaultProductSeed(name: 'Women Sports Leggings', categoryName: 'Sportswear & Activewear', sellingPricePaise: 34900, mrpPaise: 49900, purchasePricePaise: 22000, stockQuantity: 10, unit: 'piece'),
    DefaultProductSeed(name: 'Kids Frock Cotton (Age 3-4 yrs)', categoryName: 'Kids Wear', sellingPricePaise: 29900, mrpPaise: 44900, purchasePricePaise: 18000, stockQuantity: 10, unit: 'piece'),
    DefaultProductSeed(name: 'Kids School Uniform Set', categoryName: 'Kids Wear', sellingPricePaise: 54900, mrpPaise: 74900, purchasePricePaise: 35000, stockQuantity: 8, unit: 'set'),
    DefaultProductSeed(name: 'Men Casual Sneakers (Size 9)', categoryName: 'Shoes & Footwear', sellingPricePaise: 119900, mrpPaise: 169900, purchasePricePaise: 78000, stockQuantity: 6, unit: 'pair'),
    DefaultProductSeed(name: 'Women Flat Slip-On (Size 7)', categoryName: 'Shoes & Footwear', sellingPricePaise: 49900, mrpPaise: 74900, purchasePricePaise: 30000, stockQuantity: 8, unit: 'pair'),
    DefaultProductSeed(name: 'Kids School Shoes (Size 2)', categoryName: 'Shoes & Footwear', sellingPricePaise: 59900, mrpPaise: 84900, purchasePricePaise: 38000, stockQuantity: 6, unit: 'pair'),
    DefaultProductSeed(name: 'Men Leather Belt', categoryName: 'Innerwear & Accessories', sellingPricePaise: 39900, mrpPaise: 59900, purchasePricePaise: 22000, stockQuantity: 10, unit: 'piece'),
    DefaultProductSeed(name: 'Women Handbag', categoryName: 'Innerwear & Accessories', sellingPricePaise: 69900, mrpPaise: 99900, purchasePricePaise: 42000, stockQuantity: 6, unit: 'piece'),
  ],
  'hardware': [
    ...
    // Generic template names — same reasoning as clothing above.
    DefaultProductSeed(name: 'PVC Pipe 1/2 inch (1 meter)', categoryName: 'Pipes & PVC Fittings', sellingPricePaise: 3500, mrpPaise: 4000, purchasePricePaise: 2600, stockQuantity: 50, unit: 'meter'),
    DefaultProductSeed(name: 'CPVC Elbow Fitting 1 inch', categoryName: 'Pipes & PVC Fittings', sellingPricePaise: 1500, mrpPaise: 1800, purchasePricePaise: 1000, stockQuantity: 40, unit: 'piece'),
    DefaultProductSeed(name: 'Bib Cock Tap (Chrome)', categoryName: 'Sanitary & Water Taps', sellingPricePaise: 25000, mrpPaise: 32000, purchasePricePaise: 18000, stockQuantity: 10, unit: 'piece'),
    DefaultProductSeed(name: 'PVC Water Tank Connector', categoryName: 'Sanitary & Water Taps', sellingPricePaise: 8000, mrpPaise: 10000, purchasePricePaise: 6000, stockQuantity: 15, unit: 'piece'),
    DefaultProductSeed(name: 'Nerolac Exterior Emulsion Paint 4 L', categoryName: 'Paints & Wall Primer', sellingPricePaise: 139900, mrpPaise: 155000, purchasePricePaise: 118000, stockQuantity: 8, unit: 'piece'),
    DefaultProductSeed(name: 'Wall Putty 5 kg', categoryName: 'Paints & Wall Primer', sellingPricePaise: 32000, mrpPaise: 38000, purchasePricePaise: 25000, stockQuantity: 15, unit: 'piece'),
    DefaultProductSeed(name: 'Anchor Modular Switch 6A', categoryName: 'Wires, Switches & MCB', sellingPricePaise: 6500, mrpPaise: 8000, purchasePricePaise: 4800, stockQuantity: 40, unit: 'piece'),
    DefaultProductSeed(name: 'Havells 1.5 sq mm Wire (per meter)', categoryName: 'Wires, Switches & MCB', sellingPricePaise: 2500, mrpPaise: 2800, purchasePricePaise: 2000, stockQuantity: 100, unit: 'meter'),
    DefaultProductSeed(name: 'Extension Board 4 Socket with Switch', categoryName: 'Wires, Switches & MCB', sellingPricePaise: 25000, mrpPaise: 32000, purchasePricePaise: 18000, stockQuantity: 10, unit: 'piece'),
    DefaultProductSeed(name: 'Claw Hammer 500g', categoryName: 'Hand & Power Tools', sellingPricePaise: 22000, mrpPaise: 30000, purchasePricePaise: 16000, stockQuantity: 8, unit: 'piece'),
    DefaultProductSeed(name: 'Measuring Tape 5 Meter', categoryName: 'Hand & Power Tools', sellingPricePaise: 12000, mrpPaise: 15000, purchasePricePaise: 8000, stockQuantity: 15, unit: 'piece'),
    DefaultProductSeed(name: 'Bosch Cordless Drill Machine', categoryName: 'Hand & Power Tools', sellingPricePaise: 249900, mrpPaise: 299900, purchasePricePaise: 190000, stockQuantity: 3, unit: 'piece'),
    DefaultProductSeed(name: 'M8 Nut Bolt Set (Pack of 50)', categoryName: 'Screws, Nails & Fasteners', sellingPricePaise: 9500, mrpPaise: 12000, purchasePricePaise: 7000, stockQuantity: 10, unit: 'box'),
    DefaultProductSeed(name: 'Wood Screws Assorted (Pack of 100)', categoryName: 'Screws, Nails & Fasteners', sellingPricePaise: 6500, mrpPaise: 8000, purchasePricePaise: 4500, stockQuantity: 15, unit: 'box'),
    DefaultProductSeed(name: 'M-Seal Epoxy Adhesive', categoryName: 'Cement & Adhesives', sellingPricePaise: 8500, mrpPaise: 10000, purchasePricePaise: 6000, stockQuantity: 20, unit: 'piece'),
    DefaultProductSeed(name: 'Fevicol White Glue 500g', categoryName: 'Cement & Adhesives', sellingPricePaise: 15000, mrpPaise: 18000, purchasePricePaise: 11000, stockQuantity: 15, unit: 'piece'),
    DefaultProductSeed(name: 'Syska LED Bulb 12W B22', categoryName: 'LED Bulbs & Battens', sellingPricePaise: 14900, mrpPaise: 17900, purchasePricePaise: 11000, stockQuantity: 25, unit: 'piece'),
    DefaultProductSeed(name: 'Crompton Ceiling Fan 1200mm', categoryName: 'LED Bulbs & Battens', sellingPricePaise: 189900, mrpPaise: 229900, purchasePricePaise: 150000, stockQuantity: 6, unit: 'piece'),
  ],
  'restaurant': [
